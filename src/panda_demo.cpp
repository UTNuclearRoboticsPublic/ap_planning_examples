...
void show_trajectory(const trajectory_msgs::JointTrajectory &traj, moveit_visual_tools::MoveItVisualTools &visual_tools)
{
    moveit_msgs::DisplayTrajectory joint_traj;
    // joint_traj.model_id = "panda";
    joint_traj.model_id = "spot";
    ...
    joint_traj.trajectory.at(0).joint_trajectory.header.frame_id = "arm0_base_link";
...
std::queue<moveit_msgs::CollisionObject> get_collision_objects()
{
    ...
    collision_object.header.frame_id = "arm0_base_link";
...
int main(int argc, char **argv)
{
    ...
    ROS_WARN_STREAM("PAST MODEL LOADING");

    moveit::core::RobotStatePtr kinematic_state(new moveit::core::RobotState(kinematic_model));
    // std::vector<double> default_joint_state{0, -0.785, 0, -2.356, 0, 1.571, 0.785};
    std::vector<double> default_joint_state{-0.00015592575073242188, -0.8980185389518738, 1.8094338178634644,
                                            0.000377655029296875,    -0.8991076946258545, 0.0015475749969482422};
    ...
    ROS_WARN_STREAM("PAST ARM GROUP");
    ...
    ROS_WARN_STREAM("PAST PLANNER TRANSFORM");
    ...
    ROS_WARN_STREAM("PAST ADDING COLLISION OBJECTS");
    ...
    single_screw.screw_msg.header.frame_id = "arm0_base_link";
    single_request.screw_path.push_back(single_screw);
    // single_request.ee_frame_name = "panda_link8";
    single_request.ee_frame_name = "arm0_fingers";
    ...
    single_request.screw_path.at(0).screw_msg.origin = single_request.start_pose.pose.position;
